...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.material'
        db.add_column(u'portfolio_project', 'material',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.dimensions'
        db.add_column(u'portfolio_project', 'dimensions',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.material'
        db.delete_column(u'portfolio_project', 'material')

        # Deleting field 'Project.dimensions'
        db.delete_column(u'portfolio_project', 'dimensions')
