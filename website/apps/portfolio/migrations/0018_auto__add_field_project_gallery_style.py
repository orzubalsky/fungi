...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.gallery_style'
        db.add_column(u'portfolio_project', 'gallery_style',
                      self.gf('django.db.models.fields.CharField')(default='slideshow', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.gallery_style'
        db.delete_column(u'portfolio_project', 'gallery_style')
