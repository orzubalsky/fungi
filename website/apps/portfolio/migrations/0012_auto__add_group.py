...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table(u'portfolio_group', (
        ...
        db.send_create_signal(u'portfolio', ['Group'])

        # Adding M2M table for field groups on 'Project'
        m2m_table_name = db.shorten_name(u'portfolio_project_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'portfolio.project'], null=False)),
            ('group', models.ForeignKey(orm[u'portfolio.group'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'portfolio_group')

        # Removing M2M table for field groups on 'Project'
        db.delete_table(db.shorten_name(u'portfolio_project_groups'))
